        ...
        while (argum < argc && not error) 
        {
            ...
            if ( IsParam(argv[argum],"-i") ) //input Illumina file
            {
                ...
                if (argum < argc)  
                {
                    ...
                    //cout << "names->illuminaFile1 = " << names->illuminaFile1 << endl;
                    argum ++;
                    if (argum < argc)
                    {
                        error = false;
                        ...
                        //cout << "names->illuminaFile2 = " << names->illuminaFile2 << endl;
                    }
                } 
                else 
                    error = true;
...
void help_message() 
{
    ...
    cout << "version 2.3 September 2019"<<endl;
    cout << "Authors"<<endl;
    ...
    cout<< "-fastq<fastq file>"<<"\tsingle fastq input (file.fastq) the file can be gz compressed\n";
    cout<< "-sff<454 files>"<<"\t\t454 input (file.sff)\n";
    cout<< "-i<illumina files>"<<"\tIllumina inputs(file1.fastq file2.fastq) the files can be gz compressed\n";
